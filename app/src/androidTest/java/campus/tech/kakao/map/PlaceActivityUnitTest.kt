...
class PlaceActivityTest {
    ...
    fun 검색어_저장_리스트_및_데이터베이스_속_장소_추가() {
        ...
        val place = Place("카카오", "경기도 성남시 분당구 백현동 532", null, "37.3952969470752", "127.110449292622")
    ...
    fun 장소_목록_화면_제어_확인() {
        ...
        val placeList = listOf(Place("카카오", "경기도 성남시 분당구 백현동 532", null, "37.3952969470752", "127.110449292622"))
    ...
    fun 검색어_저장_목록_화면_제어_확인() {
        ...
        val searchList = listOf(Place("카카오", "경기도 성남시 분당구 백현동 532", null, "37.3952969470752", "127.110449292622"))
